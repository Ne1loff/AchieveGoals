        ...
        <div class="header__inner">
            <nav class="nav__bar">
                ...
                <div class="nav__bar__right-content" use:clickOutside on:click_outside={() => dropdownTrigger = false}>
                    <img class="avatar__btn" src="{user.male ? avatarUrl[0] : avatarUrl[1]}" alt="user_avatar"
                    ...
                    <div class="dropdown-menu"
                        ...
                        <div class="dropdown-item-profile">
                            <div class="dropdown-item-profile-inner">
                                <div class="profile__info_photo">
                                    <img class="profile__avatar" src="{user.male ? avatarUrl[0] : avatarUrl[1]}"
                                         alt="avatar">
                                </div>
                        ...
                        <div class="dropdown-item-setup">
                            <button class="dropdown-item" type="button">Reference</button>
                            <button class="dropdown-item" type="button">Settings</button>
                            <button class="dropdown-item" type="button">Send feedback</button>
                        </div>
                    </div>
                </div>
            </nav>
